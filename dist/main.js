...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(".filters--btns input[type='reset']").on("click", function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(".filters--selects-row .select").each(function () {
    var text = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).find(".select--item").eq(0).text();
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).find(".select--current").text(text);
  });
}); // <------ Selects reset END ------>
// <------ Top menu START ------>

jquery__WEBPACK_IMPORTED_MODULE_1___default()(".menu--icon a").on("click", function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(".menu-list").toggleClass("active");
}); // <------ Top menu END ------>
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()("#enter form").on("change", function () {
  var button = jquery__WEBPACK_IMPORTED_MODULE_1___default()("#enter input[type='submit']");

  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()("#enter input[type='email']").val() !== "" && jquery__WEBPACK_IMPORTED_MODULE_1___default()("#enter input[type='password']").val() !== "") {
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).ready(function () {
  ...
  var mail = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".subscribe-input");
  var mail_btn = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".subscribe-btn");
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").each(function () {
    console.log(jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).text());

    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).text() < 1) {
  ...
  var buy_btn = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".products--row-btn");
  buy_btn.on("click", function (e) {
    e.preventDefault();
    var basket = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket span").eq(2);
    var val = parseInt(basket.text()) + 1;
    console.log(val);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(basket).text(val);
  }); // <------ Add to basket END ------>
  // <------Add to favourites START ------>

  var favourite_btn = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".favourite-link");
  favourite_btn.on("click", function (e) {
    e.preventDefault();
    var basket = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket span").eq(1);
    var val = parseInt(basket.text());

    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).hasClass("selected")) {
      val--;
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).removeClass("selected");
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).text("В избранное");
    } else {
      val++;
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass("selected");
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).text("В избранном");
    }

    jquery__WEBPACK_IMPORTED_MODULE_1___default()(basket).text(val);

    if (val < 1) {
      if (!jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").eq(1).hasClass("hide")) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").eq(1).addClass("hide");
      }
    } else {
      if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").eq(1).hasClass("hide")) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").eq(1).removeClass("hide");
      }
    }
  }); // <------ Add to favourites END ------>
  // <------Add to comparison START ------>

  var comparison_btn = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".compare-link");
  comparison_btn.on("click", function (e) {
    e.preventDefault();
    var basket = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket span").eq(0);
    var val = parseInt(basket.text());

    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).hasClass("selected")) {
      val--;
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).removeClass("selected");
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).text("Сравнить товар");
    } else {
      val++;
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass("selected");
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.target).text("В сравнении");
    }

    jquery__WEBPACK_IMPORTED_MODULE_1___default()(basket).text(val);

    if (val < 1) {
      if (!jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").eq(0).hasClass("hide")) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").eq(0).addClass("hide");
      }
    } else {
      if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").eq(0).hasClass("hide")) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(".basket").eq(0).removeClass("hide");
      }
    }
